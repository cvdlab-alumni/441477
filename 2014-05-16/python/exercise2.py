...
stair = spiralStair(width=0.2,R=3,r=0.25,riser=0.1,pitch=4.4,nturns=2,steps=36)
...
tetto = COLOR(colorRGB([123,27,2]))(T(3)(12.8)(JOIN([CUBOID([20.2,23.6,1]),MK([10.1,11.8,8])])))
pavimento = COLOR(colorRGB([34,139,34]))(T(3)(-1)(CUBOID([30,40,1])))
...
macchina = T(2)(30)(S([1,2,3])([0.3,0.3,0.3])(R([2,3])(PI/2)(STRUCT([ruote,struttura]))))
...
macchinaB = T(2)(28)(S([1,2,3])([0.3,0.3,0.3])(R([2,3])(PI/2)(STRUCT([ruote,strutturaB]))))
