# -*- coding: utf-8 -*-
"""
Created on Sat Apr 12 01:09:51 2014
...
#city=COLOR(GRAY)(T([1,2,3])([-100,-100,-29.8])(CUBOID([200,200,10])))
...
#dx
filaAlberi=STRUCT(NN(4)([T(1)(3),albero]))
filaAlberi2=STRUCT(NN(3)([T(1)(3),albero]))

schieraAlberi=T([1,2,3])([40,30,-15.5])(STRUCT(NN(3)([T(2)(4),filaAlberi])))
schiera2=T([1,2,3])([48,48,-17.5])(STRUCT(NN(3)([T(2)(4),filaAlberi2])))
schiera3=T([1,2,3])([42,41,-16.5])(STRUCT(NN(5)([T(2)(3),filaAlberi2])))
...
alberi=STRUCT([schiera3,schiera2,schieraAlberi,a,b,a2,a3,a4,a5,a6,a7,b1,b6,b8,angolo1,angolo2,angolo3,angolo4,angolo5])
#tempietto
...
#strada
discesa=COLOR(colorRGB([160,160,160]))(T([1,2,3])([2,-25,-13.5])(R([2,3])(PI/6)(CUBOID([3,24,0.3]))))
strada_b=T([1,2,3])([2,-30,-13.58])(CUBOID([3,10,0.8]))
strada_c=T([1,2,3])([2,-40,-16.5])(CUBOID([3,10,0.8]))
strada_d=T([1,2,3])([2,-50,-17.3])(CUBOID([3,5,0.8]))
alberi_strada_dx=T([1,2,3])([5.5,-30,-13.3])(STRUCT(NN(3)([T(2)(2),albero])))
alberi_strada_b=T([1,2,3])([1.5,-33.5,-13.8])(STRUCT(NN(2)([T(2)(2),albero])))
alberi_strada_a=T([1,2,3])([1.5,-30,-13.3])(STRUCT(NN(3)([T(2)(2),albero])))
alberi_strada_c=T([1,2,3])([1.5,-37,-14.3])(STRUCT(NN(2)([T(2)(2),albero])))
alberi_strada_d=T([1,2,3])([1.5,-40.5,-14.9])(STRUCT(NN(2)([T(2)(2),albero])))
alberi_sx=STRUCT([alberi_strada_a,alberi_strada_b,alberi_strada_c,alberi_strada_d])
alberi_dx=T([1])([4.3])(alberi_sx)
alberi_strada=STRUCT([alberi_sx,alberi_dx])
strada=COLOR(colorRGB([160,160,160]))(JOIN([strada_d,strada_b,strada_c]))
#piazzale
piazzale1=T([1,2,3])([3,-55,-15.3])(STRUCT(MKPOLS(larPizza([0.5,15])([1,8]))))
pt_piazzale=T([1,2,3])([-15,-70,-25])(CUBOID([40,10,0.5]))
piazzale=COLOR(colorRGB([160,160,160]))(JOIN([piazzale1,pt_piazzale]))
#lampioni
h=COLOR(BLACK)(CYLINDER([0.1,3])(32))
luce=COLOR(YELLOW)(T([3])([3])(STRUCT(MKPOLS(checkModel(larSphere(0.4)())))))
lampione1=T([1,2,3])([2,-40.5,-15])(STRUCT([h,luce]))
lampione2=T([1,2,3])([5,-40.5,-15])(STRUCT([h,luce]))
lampione3=T([1,2,3])([-8,-60.5,-15])(STRUCT([h,luce]))
lampione4=T([1,2,3])([14,-60.5,-15])(STRUCT([h,luce]))
lampioni=STRUCT([lampione1,lampione2,lampione3,lampione4])
#panchina
sedile1=T(3)(0.6)(CUBOID([2,1.2,0.2]))
schienale=T(3)(0.2)(STRUCT(NN(3)([T(3)(0.5),CUBOID([2,0.3,0.2])])))
gambe=T(1)(-1.8)(STRUCT(NN(2)([T(1)(1.8),CUBOID([0.2,0.2,0.7])])))
gambe2=T(2)(1)(gambe)
rifinitura=T([1,3])([-1.8,0.8])(STRUCT(NN(2)([T(1)(1.8),CUBOID([0.2,0.2,1])])))
panchina=STRUCT([sedile1,schienale,gambe,gambe2,rifinitura])
panchina1=T([1,2,3])([-6,-65,-14.85])(S([1,2,3])([0.7,0.7,0.7])((panchina)))
panchine=COLOR(colorRGB([0,51,51]))(STRUCT(NN(6)([T(1)(2.5),panchina1])))
#cestino
baseCestino=STRUCT(MKPOLS(larPizza([0.05,0.5])([8,48])))
sopraCestino=COLOR(BLACK)(T(3)(2)(STRUCT(MKPOLS(larPizza([0.05,0.48])([8,5])))))
cestinoModel=STRUCT(MKPOLS(checkModel(larCylinder([.5,1])([20,1]))))
cestino=T(3)(1)(COLOR(BLUE)(STRUCT([baseCestino,cestinoModel])))
palo=CYLINDER([0.1,1])(32)
cestinoCompleto=STRUCT([cestino,palo,sopraCestino])
cestino1=T([1,2,3])([12,-66,-14])(S([1,2,3])([0.3,0.3,0.3])(cestinoCompleto))
cestino2=T([1,2,3])([-5.5,-66,-14])(S([1,2,3])([0.3,0.3,0.3])(cestinoCompleto))
cestini=STRUCT([cestino1,cestino2])
#siepi
siepe1=T([1,2,3])([-4,-23,-12.4])(STRUCT(MKPOLS(checkModel(larSphere(0.3)()))))
siepe2=STRUCT(NN(5)([T(1)(0.8),siepe1]))
siepe3=T([1,2])([5,-2])(R([1,2])(-PI/6)(siepe2))
siepe=COLOR(colorRGB([0,102,0]))(STRUCT([siepe2,siepe3]))



final=STRUCT([piazzale,baseMountain,solid_model_3D,town,alberi,alberi_strada,tempietto,colonne_a_terra,valleRovine,tempio2,strada,discesa,lampioni,panchine,cestini,siepe])
VIEW(final)
