...
palo=COLOR(BLACK)(CYLINDER([0.1,1])(32))
cestinoCompleto=STRUCT([cestino,palo,sopraCestino])
cestino1=T([1,2,3])([12,-64.5,-14.8])(S([1,2,3])([0.3,0.3,0.3])(cestinoCompleto))
cestino2=T([1,2,3])([-5.5,-64.5,-14.8])(S([1,2,3])([0.3,0.3,0.3])(cestinoCompleto))
